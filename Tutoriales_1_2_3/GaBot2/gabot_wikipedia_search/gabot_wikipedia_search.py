...
#El consumidor utiliza el exchange 'gabot'
...
channel.queue_bind(exchange='gabot', queue=queue_name, routing_key="wikipedia")
...
def callback(ch, method, properties, body):
    ...
    if str(body).startswith("b'[wikipedia]"):
        ...
        channel.basic_publish(exchange='gabot', routing_key="publicar_slack", body=query+":"+result)
